          ...
          <GlassCard className="overflow-hidden p-6 md:p-10 lg:p-12">
              ...
              <div className="relative max-w-3xl">
                ...
                <p className="mt-6 max-w-2xl text-base leading-8 text-[var(--fg-dim)] md:text-lg">
                  Currently building at Agneyas Labs. Always happy to talk AI/ML, GenAI, MLOps, backend, and applied ML systems where practical engineering matters more than slideware.
                </p>
